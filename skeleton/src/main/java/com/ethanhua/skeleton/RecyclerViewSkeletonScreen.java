...
public class RecyclerViewSkeletonScreen implements SkeletonScreen {
    ...
    public static class Builder {
        ...
        public Builder(RecyclerView recyclerView) {
            ...
            this.mShimmerColor = ContextCompat.getColor(recyclerView.getContext(), R.color.light_gray);
        }
        ...
        public Builder color(@ColorRes int shimmerColor) {
            this.mShimmerColor = ContextCompat.getColor(mRecyclerView.getContext(),R.color.light_gray);
            return this;
        }
